...
@push('after-styles')
    <link rel="stylesheet" href="{{ url('aqo_se/Styles/css/register.css') }}">
@endpush

@section('content')

    <div class="registerForm">
        <div class="container wide-form">
            <div class="leftSide">
                <div class="layer">
            ...
            <div class="rightSide">
                ...
                {{ html()->form('POST', route('frontend.auth.register.post'))->open() }}
                    ...
                    <div class="form-group">
                        ...
                        <select id="country" class="form-control" name="country" required style="font-size: 0.9rem;">
        ...
        <div class="container small-form d-none">
            <div class="row">
                ...
                <div class="col-12">
                    <div class="rightSide">
                        ...
                        @endif -->
                        <div class="theameRow justify-content-center">
                            <button type="submit" class="btn btn-primary submit-btn" disabled>Register</button>
                            <h6>or <a href="{{route('frontend.auth.login')}}">Sign In</a></h6>
                        </div>
                    {{ html()->form()->close() }}
