<div class="side-nav">
    ...
    <div class="buttons-section">
        <a href="{{route('frontend.user.my_competition')}}" class="btn"><i><svg xmlns="http://www.w3.org/2000/svg" width="18.348" height="25.062" viewBox="0 0 18.348 25.062">
        ...
        <a href="{{route('frontend.user.details_pending')}}" class="btn"><i><svg xmlns="http://www.w3.org/2000/svg" width="17.235" height="25.062" viewBox="0 0 17.235 25.062">
        ...
        <button class="btn"><i class="fa fa-users"></i> My Teams</button>
        <button class="btn"><i> <svg xmlns="http://www.w3.org/2000/svg" width="23.656" height="22.388" viewBox="0 0 23.656 22.388">
                ...
                </svg></i> Become a Judge</button>
        <button class="btn"><i><svg xmlns="http://www.w3.org/2000/svg" width="22.779" height="26.563" viewBox="0 0 22.779 26.563">
        ...
        <button class="btn"><i><svg xmlns="http://www.w3.org/2000/svg" width="20.656" height="20.673" viewBox="0 0 20.656 20.673">
