                ...
                <div class="container">
                    <div class="exploreBody">
                        ...
                        <div class="light-style flex-grow-1 container-p-y">
                            <form action="{{route('frontend.user.edit_competition_update')}}" method="post" id="create_formInit" enctype="multipart/form-data">
                                {{csrf_field()}}
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane fade active show" id="general">
                                                    <div class="card-body pb-2">
                                                        @include('competition::backend.competition.includes_edit.general_tabs')
                                                    </div>
                                                </div>
                                                <div class="tab-pane fade" id="comeptition">
                                                    <div class="card-body pb-2">
                                                        @include('competition::backend.competition.includes_edit.competition_tabs')
                                                    </div>
                                                </div>
                                                <div class="tab-pane fade" id="register_form">
                                                    <div class="card-body pb-2">
                                                        @include('competition::backend.competition.includes_edit.regiter_form_creator')
                                                    </div>
                                                </div>

                                                <div class="tab-pane fade" id="game_rule">
                                                    <div class="card-body pb-2">
                                                        @include('competition::backend.competition.includes_edit.game_rule_tabs')
                                                    </div>
                                                </div>

                                                <div class="tab-pane fade" id="score_board_settings">
                                                    <div class="card-body pb-2">
                                                        @include('competition::backend.competition.includes_edit.score_board_settings')
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
