                                    ...
                                    @else
                                        <div class="" style="text-align: center;margin-top: 20px;">
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-4">
                                                    <a href="{{route('frontend.explorer', ['category','keyword','desc','country','start_date','end_date'])}}" class="btn btn-primary w-100">Explore Events and Competition</a>

                                                    <br>
                                                    <br>

                                                    <button type="button" class="btn btn-primary w-100" data-toggle="modal" data-target="#editOrganizerModal">Edit Organizer Request</button>
                                                </div>
                                            </div>
    ...
    <form action="{{route('frontend.user.request_organizer_update')}}" method="post">   
        ...
        <div class="modal fade" id="editOrganizerModal" tabindex="-1" aria-labelledby="editOrganizerModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Edit Organizer Request</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Organizer Name</label>
                            <input type="text" class="form-control" name="organization" value="{{ $organizer_details->organization }}" required>
                        </div>

                        <div class="form-group">
                            <label>Contact Number</label>
                            <input type="number" class="form-control" name="contact_details"  value="{{ $organizer_details->contact_details }}" required>
                        </div>

                        <div class="form-group">
                            <label>Address</label>
                            <textarea type="number" class="form-control" name="address" rows="5"  value="{{ $organizer_details->address }}" required>{{ $organizer_details->address }}</textarea>
                        </div>
                    ...
                    <div class="modal-footer">
                        <input type="hidden" name="hidden_id" value="{{ $organizer_details->id }}">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-primary">Update Organizer Request</button>
                    </div>
                </div>
            </div>
        </div>
...
@endif
    ...
    @if(\Session::has('success'))
        ...
        <button type="button" class="btn btn-primary invisible" id="modal-btn" data-toggle="modal" data-target="#successModal"></button>

        <div class="modal fade" id="successModal" tabindex="-1" aria-labelledby="voteModal" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">

                    <div class="modal-body" style="padding: 3rem 1rem;">
                        <h4 class="mb-3 text-center">Organizer details updated successfully!</h4>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    </div>
