                    ...
                    <div class="col-12">
                        @if($top == null)
                            <div class="card-body">
                                <div style="border-style: dashed;border-width: 1px;padding: 20px;"> 
                                    <h5>Top Banner</h5>
                                    <form action="{{route('admin.explore_banner.store')}}" method="post" enctype="multipart/form-data">                    
                                        {{csrf_field()}}
                                            ...
                                            <div class="mt-4" align="right">
                                                <input type="hidden" name="top_banner" value="top_banner"/>
                                                <input type="submit" class="btn rounded-pill px-4 py-2 ml-2 ms-2 btn-success" value="Submit">
                                            </div>
                                    </form>
                                </div>
                        ...
                        @else
                            <div class="card-body">
                                <div style="border-style: dashed;border-width: 1px;padding: 20px;"> 
                                <h5>Top Banner</h5>
                                    <form action="{{route('admin.explore_banner.update')}}" method="post" enctype="multipart/form-data">                    
                                        {{csrf_field()}}
                                            ...
                                            <div class="form-group">
                                                <label>Link</label>
                                                <input type="text" class="form-control" value="{{ $top->link }}" name="link" />
                                            </div>
                                            <div class="mt-4" align="right">
                                                <input type="hidden" name="top_banner" value="top_banner"/>
                                                <input type="hidden" class="form-control" value="{{ $top->id }}" name="hidden_id" />
                                                <button type="button" class="btn rounded-pill px-4 py-2 me-2 btn-danger" data-toggle="modal" data-target="#topdelete">Delete</button>
                                                <input type="submit" class="btn rounded-pill px-4 py-2 ml-2 ms-2 btn-success" value="Update">
                                            </div>
                                    </form>
                                </div>
...
@if($homepagead != null)
 ...
 @if($top != null)
    <div class="modal fade" id="topdelete">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <a href="{{route('admin.explore_banner.delete',$top->id)}}" type="button" class="btn btn-danger">Delete</a>
                </div>
